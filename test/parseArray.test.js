...
const operations = (input) => {
  ...
  const callbackFunctions = {
    ...
    eraseInLine(params) {
      calls.push(["eraseInLine", params]);
    },
    setCharAttributes(params) {
      calls.push(["setCharAttributes", params]);
    },
    cursorUp(params) {
      calls.push(["cursorUp", params]);
    },
    cursorDown(params) {
      calls.push(["cursorDown", params]);
    },
    cursorRight(params) {
      calls.push(["cursorRight", params]);
    },
    cursorLeft(params) {
      calls.push(["cursorLeft", params]);
    },
    backspace() {
    ...
    saveCursor() {
      calls.push(["saveCursor"]);
    },
    setTextParameters(params) {
      calls.push(["setTextParameters", params]);
    },
    eraseToEndOfLine() {
      calls.push(["eraseToEndOfLine"]);
    },
    goToHome() {
      calls.push(["goToHome"]);
    },
    setGLevel() {
      calls.push(["setGLevel"]);
    },
    reverseIndex() {
      calls.push(["reverseIndex"]);
    },
    keypadApplicationMode() {
      calls.push(["keypadApplicationMode"]);
    },
    keypadNumericMode() {
      calls.push(["keypadNumericMode"]);
    },
    fullReset() {
...
test("function cursorPosition", () => {
  ...
  expect(operations(`\x1B[H text`)).toEqual([
    ["cursorPosition", []],
    ["print"],
  ]);
});
...
test.skip("osc bug", () => {
  expect(
    operations(
      decodeText(
        new Uint8Array([
          27, 93, 48, 59, 103, 105, 116, 112, 111, 100, 32, 47, 119, 111, 114,
          107, 115, 112, 97, 99, 101, 47, 116, 101, 114, 109, 116, 101, 114,
          109, 7, 27, 91, 48, 49, 59, 51, 50, 109, 103, 105, 116, 112, 111, 100,
          27, 91, 48, 48, 109, 32, 27, 91, 48, 49, 59, 51, 52, 109, 47, 119,
          111, 114, 107, 115, 112, 97, 99, 101, 47, 116, 101, 114, 109, 116,
          101, 114, 109, 27, 91, 48, 48, 109, 32, 36, 32,
        ])
      )
    ).toEqual([])
  );
...
test("special 5", () => {
  expect(
    ...
    [
      "setTextParameters",
      [
        0, 103, 105, 116, 112, 111, 100, 32, 47, 119, 111, 114, 107, 115, 112,
        97, 99, 101, 47, 116, 101, 114, 109, 116, 101, 114, 109,
      ],
    ],
    ["setCharAttributes", [1, 32]],
    ["print"],
